...
public class Activator implements BundleActivator {
   ...
   public void start(BundleContext context) throws Exception {
      ...
      props.put("com.page5of4.ms.examples.subscriber.shell.group.id", "jpa");
      props.put("com.page5of4.ms.examples.subscriber.shell.group.name", "Example");
      props.put("com.page5of4.ms.examples.subscriber.shell.commands", new String[][] {
